        ...
        <div class="product-item bg-light mb-4">
          <div class="product-img position-relative overflow-hidden">
            ...
            <div class="product-action">
              <a
                ...
                href="#"
                onclick='addSingleProductToCart({id:"${d.data[i]._id}", name:"${d.data[i].name == "LG TV's"? "LG TVs" : d.data[i].name }" ,price:${d.data[i].price},image:"${d.data[i].image}"})'
          ...
          <div class="text-center py-4">
            ...
            <div
              ...
              ${generateStarRating(d.data[i].rating)}
